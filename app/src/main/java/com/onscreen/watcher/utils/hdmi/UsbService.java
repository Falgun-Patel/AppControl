package com.onscreen.watcher.utils.hdmi;
...
public class UsbService extends Service {
    ...
    private static final String ACTION_USB_PERMISSION = "android.permission.HDMI_CEC";
    ...
    public void onCreate() {
        ...
        Toast.makeText(context, "parth start", Toast.LENGTH_SHORT).show();
    }
    ...
    public void onDestroy() {
        ...
        Toast.makeText(context, "parth stop", Toast.LENGTH_SHORT).show();
    }
            ...
            if (serialPort != null) {
                if (serialPort.open()) {
                    ...
                    if (serialPort instanceof CDCSerialDevice) {
                        context.sendBroadcast(new Intent(ACTION_CDC_DRIVER_NOT_WORKING));
                    } else {
                        context.sendBroadcast(new Intent(ACTION_USB_DEVICE_NOT_WORKING));
                    }
                }
            } else {
